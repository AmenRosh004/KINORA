...
Download the official MovieLens dataset from:
...
└── ContentBased\_final.ipynb  # Complete training pipeline
...
The trained User Tower, Movie Tower, preprocessing objects, and feature metadata are exported after training and are directly used by the KINORA Flask web application to generate real-time personalized movie recommendations.
